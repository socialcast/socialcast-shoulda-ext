...
Provides the following matcher methods:
  ...
  - change_record_count
    ...
    Can be used with the follow methods:
     ...
     - by(amount)
       Provides an expected difference for the number of records for the specified class.  Excluding this number will allow the matcher to check for any difference
